...
<html lang="zh_cn">
	 <head>
	 	<title>${configComponent.getConfig('base.titile')} | ${configComponent.getConfig('base.subtitle')}</title>
    	<#include "resource.ftl">
    	<!-- SEO start -->
    	<meta name="keywords" content="${configComponent.getConfig('base.keywords')}">
		<meta name="description" content="${configComponent.getConfig('base.description')}">
        <link rel="canonical" href="http://${configComponent.getConfig('base.url')}"/>
        <!-- SEO end -->
    </head>
	<body>
		<div class="header">
