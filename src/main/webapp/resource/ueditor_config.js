...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl: window.APP_HOME_URL + "ueditor/upload"             //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["bold","italic","underline","strikethrough","forecolor","backcolor","fontsize","fontfamily","imagenone","imageleft","imageright","imagecenter","insertimage","emotion","highlightcode","source","fullscreen","undo","redo","insertunorderedlist","insertorderedlist","link","unlink","searchreplace","preview","blockquote","horizontal"]]
